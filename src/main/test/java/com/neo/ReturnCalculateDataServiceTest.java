...
public class ReturnCalculateDataServiceTest {

    private static final Logger logger= LoggerFactory.getLogger(ReturnCalculateDataServiceTest.class);
...
//        try {
//            date=sdf.parse("2017-10-27");
//        } catch (ParseException e) {
//            e.printStackTrace();
//        }

        List<String> codeList=new ArrayList<>();
        codeList.add("000001.OF");
        codeList.add("000003.OF");
        codeList.add("000004.OF");

//        getYieldRatioArr(date,codeList,TYPE_OF_WEEK);
          getCovarianceArr(date,codeList, TYPE_OF_WEEK);
    }
